...
public class Font {
    ...
    public Map<String, BitmapFontCache> fontKoreaCache = new HashMap<String, BitmapFontCache>();
    public Map<String, BitmapFont> fontChina = new HashMap<String, BitmapFont>();
